...
import * as import9 from 'angular2-highcharts/dist/index';
...
import * as import46 from '../providers/dweet-service';
...
import * as import58 from '../pages/consumo/consumo.ngfactory';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _ChartModule_8:import9.ChartModule;
  ...
  __DeepLinker_75:any;
  __DweetService_76:import46.DweetService;
  constructor(parent:import47.Injector) {
    super(parent,[
      ...
      import56.MyAppNgFactory,
      import57.HomeNgFactory,
      import58.ConsumoPageNgFactory,
      import50.IonicAppNgFactory
    ]
    ,[import50.IonicAppNgFactory]);
  }
  ...
  get _APP_ID_30():any {
    if ((this.__APP_ID_30 == (null as any))) { (this.__APP_ID_30 = import59._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_33():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_33 == (null as any))) { (this.__EVENT_MANAGER_PLUGINS_33 = [
      ...
      new import62.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_32)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_33;
  }
  get _EventManager_34():import17.EventManager {
    if ((this.__EventManager_34 == (null as any))) { (this.__EventManager_34 = new import17.EventManager(this._EVENT_MANAGER_PLUGINS_33,this.parent.get(import63.NgZone))); }
  ...
  get _RootRenderer_38():any {
    if ((this.__RootRenderer_38 == (null as any))) { (this.__RootRenderer_38 = import64._createConditionalRootRenderer(this._DomRootRenderer_37,this.parent.get(import64.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_54():any {
    if ((this.__AppRootToken_54 == (null as any))) { (this.__AppRootToken_54 = import65.MyApp); }
  ...
  get _Keyboard_62():import35.Keyboard {
    if ((this.__Keyboard_62 == (null as any))) { (this.__Keyboard_62 = new import35.Keyboard(this._Config_22,this._Form_59,this.parent.get(import63.NgZone))); }
  ...
  get _LocationStrategy_64():any {
    if ((this.__LocationStrategy_64 == (null as any))) { (this.__LocationStrategy_64 = import8.provideLocationStrategy(this.parent.get(import66.PlatformLocation),this.parent.get(import67.APP_BASE_HREF,(null as any)),this._Config_22)); }
  ...
  get _TapClick_70():import42.TapClick {
    if ((this.__TapClick_70 == (null as any))) { (this.__TapClick_70 = new import42.TapClick(this._Config_22,this._App_23,this.parent.get(import63.NgZone))); }
  ...
  get _UrlSerializer_74():any {
    if ((this.__UrlSerializer_74 == (null as any))) { (this.__UrlSerializer_74 = import68.setupUrlSerializer(this._DeepLinkConfigToken_55)); }
    return this.__UrlSerializer_74;
  }
  get _DeepLinker_75():any {
    if ((this.__DeepLinker_75 == (null as any))) { (this.__DeepLinker_75 = import69.setupDeepLinker(this._App_23,this._UrlSerializer_74,this._Location_65)); }
    return this.__DeepLinker_75;
  }
  get _DweetService_76():import46.DweetService {
    if ((this.__DweetService_76 == (null as any))) { (this.__DweetService_76 = new import46.DweetService(this._Http_51)); }
    return this.__DweetService_76;
  }
  createInternal():import1.AppModule {
    ...
    this._ChartModule_8 = new import9.ChartModule();
    ...
    this._QueryParams_15 = import70.setupQueryParams(this._UrlToken_14);
    this._PlatformConfigToken_16 = import71.providePlatformConfigs();
    ...
    this._Platform_21 = import72.setupPlatform(this._PlatformConfigToken_16,this._QueryParams_15,this._UserAgentToken_17,this._NavigatorPlatformToken_18,this._DocumentDirToken_19,this._DocLangToken_20,this.parent.get(import63.NgZone));
    this._Config_22 = import73.setupConfig(this._ConfigToken_13,this._QueryParams_15,this._Platform_21);
    this._App_23 = new import11.App(this._Config_22,this._Platform_21);
    this._APP_INITIALIZER_24 = [
      import74.registerModeConfigs(this._Config_22),
      import75.registerTransitions(this._Config_22),
      import31.setupProvideEvents(this._Platform_21),
      import42.setupTapClick(this._Config_22,this._App_23,this.parent.get(import63.NgZone))
    ]
    ;
    this._ApplicationInitStatus_25 = new import12.ApplicationInitStatus(this._APP_INITIALIZER_24);
    this._Testability_26 = new import13.Testability(this.parent.get(import63.NgZone));
    this._ApplicationRef__27 = new import14.ApplicationRef_(this.parent.get(import63.NgZone),this.parent.get(import76.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_25,this.parent.get(import13.TestabilityRegistry,(null as any)),this._Testability_26);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import9.ChartModule)) { return this._ChartModule_8; }
    if ((token === import1.AppModule)) { return this._AppModule_9; }
    if ((token === import77.LOCALE_ID)) { return this._LOCALE_ID_10; }
    if ((token === import10.NgLocalization)) { return this._NgLocalization_11; }
    if ((token === import78.ErrorHandler)) { return this._ErrorHandler_12; }
    if ((token === import73.ConfigToken)) { return this._ConfigToken_13; }
    if ((token === import70.UrlToken)) { return this._UrlToken_14; }
    if ((token === import70.QueryParams)) { return this._QueryParams_15; }
    if ((token === import71.PlatformConfigToken)) { return this._PlatformConfigToken_16; }
    if ((token === import72.UserAgentToken)) { return this._UserAgentToken_17; }
    if ((token === import72.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_18; }
    if ((token === import72.DocumentDirToken)) { return this._DocumentDirToken_19; }
    if ((token === import72.DocLangToken)) { return this._DocLangToken_20; }
    if ((token === import72.Platform)) { return this._Platform_21; }
    if ((token === import73.Config)) { return this._Config_22; }
    ...
    if ((token === import59.APP_ID)) { return this._APP_ID_30; }
    if ((token === import79.DOCUMENT)) { return this._DOCUMENT_31; }
    if ((token === import62.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_32; }
    ...
    if ((token === import80.AnimationDriver)) { return this._AnimationDriver_36; }
    if ((token === import19.DomRootRenderer)) { return this._DomRootRenderer_37; }
    if ((token === import81.RootRenderer)) { return this._RootRenderer_38; }
    if ((token === import20.DomSanitizer)) { return this._DomSanitizer_39; }
    if ((token === import82.Sanitizer)) { return this._Sanitizer_40; }
    if ((token === import21.ViewUtils)) { return this._ViewUtils_41; }
    if ((token === import83.IterableDiffers)) { return this._IterableDiffers_42; }
    if ((token === import84.KeyValueDiffers)) { return this._KeyValueDiffers_43; }
    ...
    if ((token === import87.AppRootToken)) { return this._AppRootToken_54; }
    if ((token === import68.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_55; }
    ...
    if ((token === import67.LocationStrategy)) { return this._LocationStrategy_64; }
    ...
    if ((token === import68.UrlSerializer)) { return this._UrlSerializer_74; }
    if ((token === import69.DeepLinker)) { return this._DeepLinker_75; }
    if ((token === import46.DweetService)) { return this._DweetService_76; }
