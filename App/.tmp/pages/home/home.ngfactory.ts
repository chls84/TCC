...
class _View_Home_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Home_0_4 = new Wrapper_Home(this.parentInjector.get(import8.NavController),this.parentInjector.get(import9.Http));
...
class _View_Home0 extends import1.AppView<import0.Home> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._text_10 = this.renderer.createText((null as any),'Medidor de Consumo',(null as any));
    ...
    this._text_17 = this.renderer.createText(this._el_16,'Monitoração do consumo.',(null as any));
    ...
    this.renderer.setElementAttribute(this._el_21,'outline','');
    this._appEl_21 = new import3.AppElement(21,19,this,this._el_21);
    var compView_21:any = import14.viewFactory_Button0(this.viewUtils,this.injector(21),this._appEl_21);
    this._Button_21_4 = new import14.Wrapper_Button((null as any),'',this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_21),this.renderer);
    ...
    this.renderer.setElementAttribute(this._el_23,'color','blue');
    this.renderer.setElementAttribute(this._el_23,'name','analytics');
    this.renderer.setElementAttribute(this._el_23,'role','img');
    this._Icon_23_3 = new import18.Wrapper_Icon(this.parentInjector.get(import21.Config),new import22.ElementRef(this._el_23),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import30.Icon) && (23 === requestNodeIndex))) { return this._Icon_23_3.context; }
    if (((token === import31.Button) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._Button_21_4.context; }
    if (((token === import36.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 26)))) { return this._Content_14_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_9:any = '';
    this._Button_21_4.check_outline(currVal_9,throwOnChange,false);
    ...
    const currVal_12:any = 'analytics';
  ...
  private _handle_click_21_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this.context.goToConsumoPage()) !== false);
    return (true && pd_0);
  }
}
